...
def query_rag(
    use_ensemble: bool, ensemble_retriever: None, query_text: str, setup_database_time: str, emb_local: bool, ext_local: bool, logger_file_path: str,collection_name, prompt_template, retriever_type
):
    retriever = None
    context_text = None
    if(use_ensemble):
